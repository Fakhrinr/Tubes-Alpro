...
func LaporanInvestasi(A *tabSaham, nData *int) {
	...
	fmt.Println("---------------------")
	fmt.Printf("| %-3s | %-10s | %-5s | %-15s | %-10s | %-15s | %-12s | %-12s | %-17s | %-17s |\n", "No", "IDMember", "ID", "Nama", "Sektor", "Perusahaan", "danaAwal", "danaAkhir", "Keuntungan Kotor", "Keuntungan Bersih")
	fmt.Println("-----------------------------------------------------------------------------------------------")
